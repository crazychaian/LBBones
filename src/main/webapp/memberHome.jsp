...
<!-- 버튼 -->
	...
	<label><input onclick="movepage('memberHome.jsp');" class="iptxt" type="radio" name="band" value="am" checked><span class="inputext">TUTORIAL</span></label>
	<label><input onclick="movepage('memberHome.jsp#price');" class="iptxt" type="radio" name="band" value="am" ><span class="inputext">PRICE</span></label>

...
<!-- 버튼 -->
     <form class="btn-two">
	<label ><input onclick="movepage('#div2-id');" class="iptxt" type="radio" name="band" value="fm" checked><span class="inputext">PRODUCT<br>EXPLAIN</span></label>
	<label><input onclick="movepage('#div1-id');" class="iptxt" type="radio" name="band" value="am" checked><span></span></label>
	<label ><input onclick="movepage('#div3-id');" class="iptxt"  type="radio" name="band" value="lw"><span class="inputext"  >HOW IT<br>WORKS</span></label>
</form>
...
<script src="https://unpkg.co/gsap@3/dist/gsap.min.js"></script>
  ...
  <canvas width="1535" height="800" style="display: block; width: 1535px; height: 800px;"></canvas>
